  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
        <img src="img/banner22.jpg" style="width:100%;">
        
      </div>
    
      <div class="item">
        <img src="img/banner33.jpg" alt="New York" style="width:100%;">
        
      </div>
      <div class="item">
        <img src="img/banner44.jpg" alt="New York" style="width:100%;">
        
      </div>
      <div class="item">
        <img src="img/banner55.jpg" alt="New York" style="width:100%;">
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<a href="product.php?p=72"><div class="shop">
							...
							<div class="shop-body">
								<h3>Electronic Accessories<br>Collection</h3>
